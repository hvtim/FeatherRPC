...
# The release workflow patches this to the real version at build time.
# Unused below - kept accurate anyway.
APP_VERSION="0.1.0"
EXE_NAME="FeatherRPC"
